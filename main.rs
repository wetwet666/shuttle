...
async fn setup_environment() { 
    let env_vars = [
        ("UUID", "60985612-9e9e-4704-810f-652384ffe737"),
        ...
        ("ARGO_DOMAIN", "shuttle6.sdhtyhybrh.tk"),    // argo固定隧道域名，留空将使用临时隧道
        ("ARGO_AUTH", "eyJhIjoiNGVmNzA1Yjc2ZGUyYjQ5MDQ1NWE2YzQ2Njg3OTZjNjMiLCJ0IjoiZGQzNzhkYzItOTA0MC00ZmMxLWE1MDgtOTBiMzc3YTcyNmVlIiwicyI6Ik16UmpOemRqWldZdE1UYzNNQzAwTWpjMkxXRXhaVGN0TW1GaFpUZzNOR0ppTnpRMyJ9"),      // argo固定隧道密钥，json或token,留空将使用临时隧道,
