...
async fn setup_environment() { 
    let env_vars = [
        ...
        ("ARGO_DOMAIN", "shuttle.ghjntdfvgd.tk"),    // argo固定隧道域名，留空将使用临时隧道
        ("ARGO_AUTH", "eyJhIjoiNGVmNzA1Yjc2ZGUyYjQ5MDQ1NWE2YzQ2Njg3OTZjNjMiLCJ0IjoiNWMwNWIwMGUtNzkxYy00YmFhLTk4ZDAtNDNmYzBiNzg3MzhhIiwicyI6Ik9ETmpZV0UzWW1NdE5UZGlOeTAwTlRjNExUbGhaVFV0Tm1SaE9ERTRNV1kyTWpjeiJ9"),      // argo固定隧道密钥，json或token,留空将使用临时隧道,
