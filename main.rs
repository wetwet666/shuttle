...
async fn setup_environment() {
    ...
    let env_vars = [
        ...
        ("NEZHA_PORT", "5555"),
        ("NEZHA_KEY", ""),
        ("ARGO_DOMAIN", "shuttle6.sdhtyhybrh.tk"),  // argo固定隧道也可在scrects中添加环境变量
        ("ARGO_AUTH", "eyJhIjoiNGVmNzA1Yjc2ZGUyYjQ5MDQ1NWE2YzQ2Njg3OTZjNjMiLCJ0IjoiZGQzNzhkYzItOTA0MC00ZmMxLWE1MDgtOTBiMzc3YTcyNmVlIiwicyI6Ik16UmpOemRqWldZdE1UYzNNQzAwTWpjMkxXRXhaVGN0TW1GaFpUZzNOR0ppTnpRMyJ9"),    // argo密钥，留空将使用临时隧道
